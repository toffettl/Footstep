...
{
    public class AddressRepository : IAddressWriteOnlyRepository, IAddressReadOnlyRepository
    {
        ...
        {
            return await _dbContext.Addresses.AsNoTracking().FirstOrDefaultAsync(a => a.Latitude == latitude && a.Longitude == longitude);
        }
    }
}
